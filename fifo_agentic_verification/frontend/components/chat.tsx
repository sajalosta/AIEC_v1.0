...
const SUGGESTIONS = [
  "1. reset behavior, 2. FIFO ordering",
  "Test the full flag and blocked writes",
  "Verify pointer wraparound and read latency",
];
          ...
          {messages.length === 0 && (
            <div className="mt-10 flex flex-col items-center gap-6 text-center">
              ...
              <div className="space-y-1">
                <h2 className="text-lg font-medium">Name the features to verify</h2>
